					...
					<div class="container">
						<div class="row py-5">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-color-dark font-weight-bold text-9">O nama</h1>
							</div>
				...
				<div class="container pt-4 pb-5">
					<div class="row align-items-xl-center">
						...
						<div class="col-lg-6 ps-lg-4 ps-xl-5">
							<h3 class="text-color-dark text-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Dobrodošli na službenu stranicu Stomatologije Dakić</h3>
							<p class="text-3-5 font-weight-medium pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Stomatološka ordinacija Dr Dakić osnovana je 2015. godine, a nalazi se u ulici Nikole Tesle 23/4 u Bijeljini.</p>
					...
					<div class="row pt-5">
						<div class="col">
							<p class="font-weight-medium text-4-5 line-height-5">Uz upotrebu najsavremenijih metoda i materijala u našoj ordinaciji vršimo usluge iz sledećih oblasti stomatologije:</p>
							<p class="text-3-5">
								<ul>
					...
					<div class="row pt-5">
						<div class="col">
							<p class="text-3-5">Od momenta kada prvi put pređete naš prag budite sigurni da se ste na putu potpunog oporavka i trajnog rešavanja svih zubnih problema.</p>
							<hr class="my-5 p-0">
						</div>
					</div>

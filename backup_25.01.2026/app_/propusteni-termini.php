<?php 
    ...
    if(isset($_SESSION["logged_in"])){  
        ...
        $propusteni = new propusteniTermini;
        $propusteni = $propusteni->fetch_all_propusteni();
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h5 class="mb-0 text-gray-800">Pregled propuštenih termina</h5>
            </div>
                ...
                <div class="col-lg-12">
                    <table class="table centeredTable">
                        ...
                        <tbody>
                            ...
                            foreach($propusteni as $propusteni){ 

                                $id_kartona = intval($propusteni['termini_idpacijenta']);
                                $karton = new singleKarton;
                                $karton = $karton->fetch_single_karton($id_kartona);
                                
                                $id_kdoktora = intval($propusteni['termini_iddoktora']);
                                $doktor = new singleUser;
                                $doktor = $doktor->fetch_single_user($id_kdoktora);

                            ?>
                            <tr>
                                <td scope="row"><?php echo $propusteni['termini_id'] ?></td>
                                ...
                                <td><?php echo date('d.m.Y.',strtotime($propusteni['termini_datum'])) ?></td>
                                <td><?php echo $propusteni['termini_vrijeme'] ?></td>
                                <td><?php echo $propusteni['termini_napomena'] ?></td>
                                <td><?php echo $propusteni['termini_status'] ?></td>
                                <td><?php echo $propusteni['termini_autor'] ?></td>
                                <td><?php echo date('d.m.Y. H:m:s',strtotime($propusteni['termini_timestamp'])) ?></td>

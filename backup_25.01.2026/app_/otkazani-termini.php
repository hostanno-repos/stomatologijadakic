<?php 
    ...
    if(isset($_SESSION["logged_in"])){  
        ...
        $otkazani = new otkazaniTermini;
        $otkazani = $otkazani->fetch_all_otkazani();
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h5 class="mb-0 text-gray-800">Pregled otkazanih termina</h5>
            </div>
                ...
                <div class="col-lg-12">
                    <table class="table centeredTable">
                        ...
                        <tbody>
                            ...
                            foreach($otkazani as $otkazani){ 

                                $id_kartona = intval($otkazani['termini_idpacijenta']);
                                $karton = new singleKarton;
                                $karton = $karton->fetch_single_karton($id_kartona);
                                
                                $id_kdoktora = intval($otkazani['termini_iddoktora']);
                                $doktor = new singleUser;
                                $doktor = $doktor->fetch_single_user($id_kdoktora);

                            ?>
                            <tr>
                                <td scope="row"><?php echo $otkazani['termini_id'] ?></td>
                                ...
                                <td><?php echo date('d.m.Y.',strtotime($otkazani['termini_datum'])) ?></td>
                                <td><?php echo $otkazani['termini_vrijeme'] ?></td>
                                <td><?php echo $otkazani['termini_napomena'] ?></td>
                                <td><?php echo $otkazani['termini_status'] ?></td>
                                <td><?php echo $otkazani['termini_autor'] ?></td>
                                <td><?php echo date('d.m.Y. H:m:s',strtotime($otkazani['termini_timestamp'])) ?></td>

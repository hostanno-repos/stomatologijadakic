...
if(isset($_SESSION["logged_in"]) && $now < $_SESSION['expire']){
    ...
    $odbijeni_ = new odbijeniTermini;
    $odbijeni_ = $odbijeni_->fetch_all_odbijeni();
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mobile-content">
                        <?php foreach($odbijeni_ as $zahtjevi){ 

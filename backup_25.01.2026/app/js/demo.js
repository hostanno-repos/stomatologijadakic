      ...
      $.ajax({    
        ...
        success: function(response){                    
          $.each(JSON.parse(response), function(i,item){
            var itemArray = {
              id: item.termini_id,
              name: item.termini_vrijeme.slice(0, 5),
              description: "Pacijent: <a href='detalji-kartona.php?detaljiKartona="+item.termini_idpacijenta+"'>"+item.termini_pacijent+"</a><br>"+"Doktor: "+item.termini_doktor+"<br>"+"Napomena: "+item.termini_napomena+"<br>"+"<div class='three-buttons'><a class='three-buttons-confirmed' href='potvrdi-dolazak.php?idtermina="+item.termini_id+"'><i class='fa-solid fa-check'></i></a><a class='three-buttons-missed' href='propusti-termin.php?idtermina="+item.termini_id+"'><i class='fa-solid fa-minus'></i></a><a class='three-buttons-declined' href='otkazi-termin.php?idtermina="+item.termini_id+"'><i class='fa-solid fa-xmark'></i></a></div>",
              date: new Date(item.termini_datum),
              type: "birthday",
              everyYear: !0
          }
            eventArray.push(itemArray);
          })   

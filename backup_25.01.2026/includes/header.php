							...
							<nav class="header-nav-top">
								<ul class="nav nav-pills">
									<li class="nav-item py-2 d-none d-sm-inline-flex pe-2">
										<span class="ps-0 font-weight-semibold text-color-default text-2"><i class="icon-location-pin icons text-color-tertiary p-relative top-3 text-4-5"></i> Nikole Tesle 23/4, 76300 Bijeljina</span>
									</li>
								</ul>
							</nav>
						</div>
							...
							<nav class="header-nav-top">
								<ul class="nav nav-pills p-relative bottom-2">
									<li class="nav-item py-2 d-none d-md-inline-flex">
										<a href="mailto:info@stomatologijadakic.com" class="text-2 font-weight-semibold text-color-default text-color-hover-tertiary"><i class="icon-envelope icons text-color-tertiary p-relative top-3 text-4-5"></i> info@stomatologijadakic.com</a>
									</li>
									<li class="nav-item py-2 pe-2">
										<span class="text-2 font-weight-semibold text-color-default d-none d-lg-block"><i class="icon-clock icons text-color-tertiary p-relative top-3 text-4-5"></i> Pon-Pet 9:00-18:00 / Sub-Ned - ZATVORENO</span>
									</li>
									<li class="nav-item py-2 pe-2">
										<a href="tel:+387 66 096 666" class="text-2 font-weight-semibold text-color-default text-color-hover-tertiary"><i class="icon-phone icons text-color-tertiary p-relative top-2 text-4-5"></i> +387 66 096 666</a>
									</li>
								</ul>
							</nav>
						</div>
							...
							<div class="header-nav-main header-nav-main-square header-nav-main-text-capitalize header-nav-main-text-size-4 header-nav-main-dropdown-no-borders header-nav-main-arrows header-nav-main-full-width-mega-menu header-nav-main-mega-menu-bg-hover header-nav-main-effect-2">
								<nav class="collapse">
									<ul class="nav nav-pills" id="mainNav">
										...
										<li class="dropdown">
											<a class="nav-link dropdown-toggle <?php if($active == "usluge"){echo('active'); } ?>">Usluge</a>

					...
					<div class="container p-relative z-index-3 h-100">
						<div class="row align-items-center h-100">
							<div class="col-lg-8 col-xl-6 text-center text-md-start">
								<h2 class="font-weight-semi-bold text-color-dark text-9 text-md-12 line-height-2 mb-3 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200" data-plugin-options="{'minWindowWidth': 0}">Kreirajmo Vaš osmjeh zajedno!</h2>
								<p class="font-weight-medium text-4-5 line-height-5 mb-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400" data-plugin-options="{'minWindowWidth': 0}">Uvjerite si i Vi da pružamo najbolju uslugu iz svih oblasti stomatologije.</p>
							</div>
						</div>
					</div>
				</div>

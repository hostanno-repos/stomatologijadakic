				...
				<div role="main" class="main">
							...
							<div class="row align-items-center text-center text-md-start">
								<div class="col-lg-9 mb-3 mb-lg-0">
									<p class="text-color-light text-4-5 font-weight-medium line-height-4 mb-0">
										<strong>Rezervišite svoj termin online</strong> - Trebate hitnu rezervaciju? Pozovite nas na <u>+387 66 096 666</u>
									</p>
								</div>
										...
										<div class="col-lg-4 px-lg-3">
											<div class="featured-box featured-box-primary">
												<div class="box-content">
													...
													<h4 class="font-weight-semi-bold mt-3 pt-2 mb-3 text-5-5 text-color-dark">Super lokacija</h4>
													<p class="mb-0 text-3-5 font-weight-medium">Nalazimo se u samom centru grada, posjedujemo svoj parking i caffe bar.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-4 px-lg-3">
											<div class="featured-box featured-box-secondary">
												<div class="box-content">
													...
													<h4 class="font-weight-semi-bold mt-3 pt-2 mb-3 text-5-5 text-color-dark">Odlična usluga</h4>
													<p class="mb-0 text-3-5 font-weight-medium">Mi brinemo o svakom pacijentu, Vaše zadovoljstvo je naš uspjeh.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-4 px-lg-3">
											<div class="featured-box featured-box-tertiary">
												<div class="box-content">
													...
													<h4 class="font-weight-semi-bold mt-3 pt-2 mb-3 text-5-5 text-color-dark">Najbolji stručnjaci</h4>
													<p class="mb-0 text-3-5 font-weight-medium">Zapošljavamo samo vrhunske stručnjake stomatologije.</p>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="row align-items-xl-center">
								...
								<div class="col-lg-6 ps-lg-4 ps-xl-5">
									...
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
										<a href="#" class="btn btn-secondary border-0 text-3 font-weight-semi-bold btn-px-5 btn-py-3">Pogledajte naše uslue</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="container py-5 my-2">
							<div class="row">
								<div class="col-lg-6 mb-5 mb-lg-0">
									<h2 class="d-inline-block line-height-5 text-4 positive-ls-3 font-weight-semibold text-color-primary mb-2 appear-animation" data-appear-animation="fadeInUpShorter">NAJBOLJE USLUGE</h2>
									<h3 class="text-color-dark text-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Nudimo najbolje usluge iz svih oblasti stomatologije.</h3>
									<p class="text-3-5 font-weight-medium pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Stomatologija "Dakić" nudi široku lepezu usluga iz svih oblasti stomatologije, a pored tog vodimo brigu o svakom našem pacijentu. Uvjerite se u kvalitetu naših usluga!</p>
									
								</div>

								<div class="col-lg-6 mb-5">
									<ul class="list list-icons list-icons-lg ms-lg-3 mt-lg-4 pt-lg-2">
										<li class="text-3-5 font-weight-medium appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200"><i class="fas fa-check text-color-tertiary"></i> <span class="ps-2 d-block">Kod nas nikad nećete dva puta rješavati isti problem. Mi radimo detaljno i temeljno.</span></li>
							...
							<div class="row align-items-center text-center text-md-start pt-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								<div class="col-lg-9 mb-3 mb-lg-0">
									<p class="text-color-primary text-4-5 font-weight-medium line-height-4 mb-0">
										<strong>Rezervišite svoj termin online</strong> - Trebate hitnu rezervaciju? Pozovite <u>+387 66 096 666</u>
									</p>
								</div>
								<div class="col-lg-3 text-center text-md-start text-lg-end">
									<a href="demo-dentist-contact.html#book" class="btn btn-secondary border-0 text-3-5 font-weight-semi-bold btn-px-5 btn-py-3">Rezervišite termin</a>
						...
						<div class="container py-5 my-2">
							<div class="row">
								<div class="col text-center">
									<h2 class="d-inline-block line-height-5 text-4 positive-ls-3 font-weight-semibold text-color-primary mb-2 appear-animation" data-appear-animation="fadeInUpShorter">NAŠI STOMATOLOZI</h2>
									<h3 class="text-color-dark text-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Upoznajte naše zaposlene</h3>
														...
														<span class="thumb-info-wrapper overlay overflow-hidden">
															...
															<span class="thumb-info-title bottom-30 bg-transparent w-100 mw-100 p-0">
																<span class="thumb-info-swap-content-wrapper">
																	...
																	<span class="thumb-info-inner text-2">
																		<p class="px-5 text-4 text-lg-2 opacity-7 font-weight-medium text-light">Član vrhunskog tima koji će vas svaki put dočekati s osmjehom na licu.</p>
					...
					<section class="section border-0 bg-color-light m-0 py-5">
						<div class="container py-5 my-2">
							<div class="row">
								<div class="col text-center">
									<h2 class="d-inline-block line-height-5 text-4 positive-ls-3 font-weight-semibold text-color-primary mb-2 appear-animation" data-appear-animation="fadeInUpShorter">Naručite se online</h2>
									<h3 class="text-color-dark text-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Rezervišite svoj termin</h3>
									<p class="text-3-5 font-weight-medium pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Pošaljite nam dan i vrijeme kada želite da budete naručeni, a mi ćemo Vas kontaktirati što prije da Vam potvrdimo Vašp termin.</p>

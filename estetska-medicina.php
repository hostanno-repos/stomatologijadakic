					...
					<div class="container">
						<div class="row py-5">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-color-dark font-weight-bold text-9">Estetska medicina</h1>
							</div>
				...
				<div class="container pt-4 pb-5 mb-4">
					...
					<div class="row pb-5">
						<div class="col-lg-8 pe-lg-5">
							<p>Estetska medicina je nova, vrlo popularna grana medicine i svakim danom se sve više razvija. Estetska medicina koristi prednosti savremenih tehnoloških dostignuća. Nastala je kao odgovor na potrebe savremenog čoveka da izgleda mlađe i ljepše.</p>
							<p>Objedinjuje medicinske neinvazivne i minimalno invazivne procedure, čiji je rezultat očuvanje i unapređenje fizičkog izgleda, a samim tim i veće samopouzdanje.</p>

							<p class="font-weight-medium text-4-5 line-height-5">Nudimo Vam usluge:</p>
							<ul>
								<li>Botox</li>
								<li>Hijaluronski fileri</li>
								<li>Mezoterapija lica</li>
							</ul>
						</div>
						<div class="col-lg-4 text-center pt-4 pt-lg-0">
							<img src="<?php echo htmlspecialchars(function_exists('getSiteImage') ? getSiteImage('usluge_estetika') : 'img/usluge-slider/estetika.jpg'); ?>" class="img-fluid box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-delay="100" data-appear-animation-duration="600ms" />
						</div>
					</div>
				</div>
		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<section class="page-header page-header-modern bg-color-quaternary p-relative">
					<div class="container">
						<div class="row py-5">
							...
							<div class="col-md-4 order-1 order-md-2 align-self-center">
								<ul class="breadcrumb d-flex justify-content-md-end text-4 font-weight-medium">
									<li class="text-capitalize"><a href="demo-dentist.html" class="text-color-default text-color-hover-primary text-decoration-none text-capitalize">Početna</a></li>
									<li class="text-capitalize active">Usluge</li>
								</ul>
							</div>
						</div>
				...
				<div class="container pt-4 pb-5 mb-4">
					...
					<div class="row pb-5">
						<div class="col-lg-8 pe-lg-5">
							<p class="font-weight-medium text-4-5 line-height-5">Kada su u pitanju naši najmlađi pacijenti najvažniji zadaci našeg tima su:</p>
							<ul>
								<li>Prevencija i liječenje bolesti usta i zuba kod djece</li>
								<li>Sticanje povjerenja djeteta i roditelja</li>
								<li>Davanje savjeta roditeljima i djetetu kako očuvati oralno zdravlje</li>
							</ul>
							...
							<p>Zato je idealno da dijete dovedete stomatologu dok još nema tegoba, pa ćemo prvu posjetu iskoristiti za upoznavanje djeteta sa novom sredinom, kao i uspostavljanje komunikacije stomatologa sa djetetom i roditeljima.</p>
					...
					<div class="row pt-lg-3">
						...
						<div class="col-md-4 col-lg-3 text-center text-md-start">
							<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100">
								<h3 class="font-weight-bold mb-3 text-5-5 text-color-dark text-capitalize">Spremni?</h3>
								<p class="pb-1 mb-3">Tu smo i za naše najmlađe. Neka dolazak kod zubara bude zabava!</p>

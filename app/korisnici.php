      ...
      <div class="body flex-grow-1 px-3">
        <div class="container-fluid">
          ...
          <div class="row desktop-content">
            <h3 class="mb-3">Pregled osoblja</h3>

            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <button class="btn btn-success" data-toggle="modal" data-target="#insertModal">Dodaj korisnika</button>
            </div>
            ...
            <div class="row mobile-content">
                ...
                <?php foreach($user_ as $user){ ?>
                <div class="col-lg-12">
                    <div class="card border-dark mb-3">
                        <div class="card-header bg-transparent border-dark">
                            <h5 class="card-title mb-0"><?php echo $user['user_ime'] ?> <?php echo $user['user_prezime'] ?></h5>
                        </div>
                        <div class="card-body text-dark">
                            <p class="card-text">
                            Korisničko ime: <?php echo $user['user_name'] ?> <br />
                            Tip korisnika: <?php echo $user['user_type'] ?> <br />
                            </p>
                        </div>
                        <div class="card-footer bg-transparent border-dark">
                            <button style="border:1px solid #ccc;border-radius:2px;">
                                <i 
                                class="fa-solid fa-lock"
                                data-toggle="modal" 
                                data-target="#editResetPassword"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="korisnici.php" method="post" autocomplete="off" id="insert_form" enctype='multipart/form-data'>
                                <div class="modal-body">
                                    ...
                                    <!-- ACTIVE -->
                                    <input name="user_active" type="text" value="1" readOnly>
                                    <!-- AUTHOR -->

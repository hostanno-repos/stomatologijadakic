            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <table class="table centeredTable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Prihvati zahtjev</th>
                                    <th scope="col">Odbij zahtjev</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                
                                foreach($zahtjevi as $zakazani){ 
                                ...
                                <tr>
                                    ...
                                    <td><a href="prihvati-zahtjev.php?prihvatiZahtjev=<?php echo($zakazani['termini_id']); ?>"><i class="fa-solid fa-check"></i></a></td>
                                    <td><a href="odbij-zahtjev.php?odbijZahtjev=<?php echo($zakazani['termini_id']); ?>"><i class="fa-solid fa-xmark"></i></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="col-lg-12 mobile-content">
                        <?php foreach($zahtjevi as $zahtjevi){ 

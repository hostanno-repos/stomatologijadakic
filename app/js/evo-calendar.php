...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForToday: "Nemate zakazanih termina.. :)",
                        noEventForThisDay: "Nemate zakazanih termina.. :)",
                    ...
                    sr: {
                        ...
                        closeEventListText: "Zatvori lsitu termina"
                    },
                    es: {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup = '<div class="calendar-sidebar">'+
                        ...
                        '<ul class="calendar-months">'+
                            '<li class="month" role="button" data-month-val="0">Januar</li>'+
                            '<li class="month" role="button" data-month-val="1">Februar</li>'+
                            '<li class="month" role="button" data-month-val="2">Mart</li>'+
                            '<li class="month" role="button" data-month-val="3">April</li>'+
                            '<li class="month" role="button" data-month-val="4">Maj</li>'+
                            '<li class="month" role="button" data-month-val="5">Jun</li>'+
                            '<li class="month" role="button" data-month-val="6">Jul</li>'+
                            '<li class="month" role="button" data-month-val="7">Avgust</li>'+
                            '<li class="month" role="button" data-month-val="8">Septembar</li>'+
                            '<li class="month" role="button" data-month-val="9">Oktobar</li>'+
                            '<li class="month" role="button" data-month-val="10">Novembar</li>'+
                            '<li class="month" role="button" data-month-val="11">Decembar</li>'+
                        '</ul>';
            markup += '</div></div>';
            ...
            markup += '<div class="calendar-events">'+
                            '<div class="event-header"><p></p><a>+</a></div>'+
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        _.$active.events = [];
        // Event date
        var title = _.formatDate(_.$active.date, _.options.eventHeaderFormat, 'sr');
        ...
        var title2 = formatDate_(_.$active.date);
        console.log(title2);
        /* date end */
        ...
        console.log(title2);
        var title3 = toTimeStamp(title2);

        title3 = title3.toString();
        console.log(title3);

        title3 = title3.replaceAll("0", "a");
        title3 = title3.replaceAll("1", "b");
        title3 = title3.replaceAll("2", "c");
        title3 = title3.replaceAll("3", "d");
        title3 = title3.replaceAll("4", "e");
        title3 = title3.replaceAll("5", "f");
        title3 = title3.replaceAll("6", "g");
        title3 = title3.replaceAll("7", "h");
        title3 = title3.replaceAll("8", "i");
        title3 = title3.replaceAll("9", "j");


        $(".event-header>a").remove();
        $(".event-header").append("<a href='dodaj-termin.php?datum="+title3+"'>+</a>");
        // Event list
    ...
    EvoCalendar.prototype.buildCalendar = function() {
        ...
        title = new Date(_.$label.months[_.$active.month] +' 1 '+ _.$active.year).toLocaleString("sr-Latn-RS", { month: "long" });

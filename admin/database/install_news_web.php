<?php
/**
 * Web-based News Table Installation Script
 * Access this file through your browser to set up news table
 * Example: http://localhost/dakic_cms/admin/database/install_news_web.php
 * 
 * @package    DakicCMS
 * @subpackage Admin
 */
...
<head>
    ...
    <title>News Table Installation - Dakic CMS</title>
    <style>
        body {
        ...
        <?php if ($step === '1'): ?>
            <div class="info">
                ...
                <ul>
                    ...
                    <li>Ovo će kreirati tabelu <code>news</code> za upravljanje novostima</li>
                </ul>
            </div>
            ...
            <a href="?step=2" class="btn btn-primary">Kreiraj News tabelu</a>
        ...
        <?php elseif ($step === '2'): ?>
            ...
            try {
                ...
                if ($stmt->rowCount() === 0) {
                    ...
                    $success[] = "Tabela users pronađena. Nastavljam sa kreiranjem news tabele.";
                    ...
                    $success[] = "Tabela news je uspešno kreirana.";
            ...
            <?php if (!empty($success)): ?>
                ...
                <div class="info" style="margin-top: 20px;">
                    ...
                    <ul>
                        <li><code>news</code> - Čuva informacije o novostima sa mogućnošću ručnog definisanja datuma objave</li>
                    </ul>
                    <p>Sada možete koristiti sekciju Novosti u admin panelu.</p>
                </div>
                
                <a href="../../news" class="btn btn-primary">Idi na Novosti</a>

					...
					<div class="container">
						<div class="row py-5">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-color-dark font-weight-bold text-9">Implantologija</h1>
							</div>
				...
				<div class="container pt-4 pb-5 mb-4">
					...
					<div class="row pb-5">
						<div class="col-lg-8 pe-lg-5">
							...
							<p>Zubni implantati predstavljaju kvalitetno i dugotrajno rješenje za nadoknadu zuba koji nedostaju. Napredak tehnologije povećao je upotrebu zubnih implantata u posljednjoj deceniji. Implantat je dug između 8 i 16 mm i ubacuje se u viličnu kost, gdje zamjenjuje korijen zuba. </p>
